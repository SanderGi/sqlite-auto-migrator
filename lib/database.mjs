...
export default class Database {
    ...
    /**
     * Gets a single row from a SQL query with parameters.
     * @param {string} sql the SQL query to run
     * @param {any[]} [params] the parameters to bind to the query. Supports a dictionary with `:name`, `@name` and `$name` style parameters, or an array with `?` position based parameters.
    ...
    /**
     * Gets all rows from a SQL query with parameters.
     * @param {string} sql the SQL query to run
     * @param {any[]} [params] the parameters to bind to the query. Supports a dictionary with `:name`, `@name` and `$name` style parameters, or an array with `?` position based parameters.
    ...
    /**
     * Runs a SQL query with parameters and returns the rows one by one as an async generator (useful for saving memory with large query results).
     * @param {string} sql the SQL query to run
     * @param {any[]} [params] the parameters to bind to the query. Supports a dictionary with `:name`, `@name` and `$name` style parameters, or an array with `?` position based parameters.
