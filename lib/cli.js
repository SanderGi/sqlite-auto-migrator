    ...
    if (cmd === 'status') {
        ...
        console.log(
            `  ${symbols.bullet} SAM_ON_CHANGED_INDEX ${colors.FgGray(
                'how to handle an index change, one of `PROMPT`, `PROCEED`, `SKIP`, or `REQUIRE_MANUAL_MIGRATION` (default: `PROMPT`)',
            )}`,
        );
        console.log(
            `  ${symbols.bullet} SAM_ON_CHANGED_VIEW ${colors.FgGray(
                'how to handle a view change, one of `PROMPT`, `PROCEED`, `SKIP`, or `REQUIRE_MANUAL_MIGRATION` (default: `PROMPT`)',
            )}`,
        );
        console.log(
            `  ${symbols.bullet} SAM_ON_CHANGED_TRIGGER ${colors.FgGray(
                'how to handle a trigger change, one of `PROMPT`, `PROCEED`, `SKIP`, or `REQUIRE_MANUAL_MIGRATION` (default: `PROMPT`)',
            )}`,
        );
        console.log(
